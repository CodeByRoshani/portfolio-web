  ...
  education: [
    {
      ...
      institution: "Government Polytechnic, Dehri-on-Sone",
      duration: "2024 - 2027",
  ...
  internships: [
    {
      ...
      company: "SHATYARTH TECHNOLOGY PVT. LTD.",
      duration: "Jun 2025 - Jul 2025",
      certificateUrl: "https://drive.google.com/file/d/1TEwErl4x3eTt4h0218ymH4_Z8i3KisEY/view?usp=drivesdk",
      points: [
        "Developed responsive and interactive web pages using React.js, Tailwind CSS, and modern JavaScript (ES6+).",
        "Integrated RESTful APIs with frontend components, managing asynchronous state and optimizing page loading times.",
        "Collaborated on UI/UX improvements, ensuring pixel-perfect layout alignment across mobile and desktop screens."
      ]
    },
    {
      ...
      certificateUrl: "https://drive.google.com/file/d/1LcE2D5waQeHKB43yR-mEAASpXdlmBSLq/view?usp=drivesdk",
      points: [
        "Performed Data Cleaning, Exploratory Data Analysis (EDA), and preprocessing on complex datasets using Python.",
        "Created actionable data visualizations and dashboards to identify key performance trends and metrics.",
        "Applied statistical methods and machine learning fundamentals to derive meaningful insights for project reporting."
      ]
    }
  ],
  projects: [
...
,
  ...
  certifications: [
    {
      name: "1st Year Branch Topper Certificate",
      issuer: "Government Polytechnic, Dehri-on-Sone",
      year: "2025",
      type: "Academic",
      verifyLink: "https://drive.google.com/file/d/1R_3LdgmuwjwjojzsTrrpGtSGRsNzJ1DG/view?usp=drivesdk"
    },
    {
      name: "2nd Year Branch Topper Certificate",
      issuer: "Government Polytechnic, Dehri-on-Sone",
      year: "2026",
      type: "Academic",
      verifyLink: "https://drive.google.com/file/d/1VRayH_AdEQCUb-1Rf-ESYIAy5G2UVrUr/view?usp=drivesdk"
    },
    {
      name: "Java Programming & OOPs Certification",
      issuer: "Knowledge Gate",
      year: "2025",
      type: "Technical",
      verifyLink: "https://www.knowledgegate.ai/certificate/B6F9361E"
    },
    {
      name: "JavaScript (Advanced ES6+ & Web Development)",
      issuer: "Knowledge Gate",
      year: "2025",
      type: "Technical",
      verifyLink: "https://www.knowledgegate.ai/certificate/04096895"
    },
    {
      name: "Artificial Intelligence & Generative AI Foundation",
      issuer: "AI Technical Training",
      year: "2026",
      type: "Technical",
      verifyLink: "https://drive.google.com/file/d/104JRWw26XbjzlgQpfLiXYyaD0LUOAGQC/view?usp=drivesdk"
    }
  ],
  achievements: [
